print("Starting the Smart HealthCare Recommendation System...")
...
def recommendDoctors():
    ...
    if answer.lower() == 'yes':
        ...
        print("Thank you for using the Smart HealthCare Recommendation System!")
...
while True:
    doctors_info_df=pd.read_csv('./Datasets/Doctors_info.csv')
    print("\n---------------------------------------------------------------------------------")
    print("               Welcome to JeevanSuraksha - Smart HealthCare Recommendation System               ")
    print("-----------------------------------------------------------------------------------\n")
    ...
    if choice == '1':
        ...
        print("Exiting JeevanSuraksha - Smart HealthCare Recommendation System. Goodbye!")
        break
    else:
